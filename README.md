...
3. **İndirme ve Çıkartma:** Sağ taraftaki **"Releases"** bölümünden oyunun `.zip` dosyasını bilgisayarınıza indirin ve masaüstüne çıkartın.
4. **Sisteme Kayıt (Tek Seferlik):** Çıkarttığınız klasörün içindeki `Bombom.exe` dosyasına **sadece bir kere** çift tıklayıp açın. 
